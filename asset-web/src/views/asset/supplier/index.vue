  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item prop="supplierType">
        ...
        >
          <el-option
            v-for="type in supplierTypeList"
            :key="type"
            :label="type"
            :value="type"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['asset:supplier:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['asset:supplier:export']"
        >导出</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['asset:supplier:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" width="550px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-form-item label="供应商类型" prop="supplierType">
          <el-input v-model="form.supplierType" placeholder="请输入供应商类型" />
        </el-form-item>
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/asset/supplier"
